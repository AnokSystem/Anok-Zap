...
import { Users, Search, Edit, Link, Loader2 } from 'lucide-react';
...
interface GroupsListProps {
  ...
  onCopyGroupLink: (link: string, groupName: string) => void;
}
              ...
              <div key={group.id} className="p-4 bg-gray-700/30 rounded-lg border border-gray-600">
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <Button 
                    ...
                    variant="outline" 
                    className="bg-gray-800 border-gray-600"
                    onClick={() => onCopyGroupLink(`https://chat.whatsapp.com/${group.id}`, group.name)}
                  >
