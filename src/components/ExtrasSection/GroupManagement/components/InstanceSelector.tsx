    ...
    <div className="flex gap-3">
      <div className="flex-1">
        ...
        <Select value={selectedInstance} onValueChange={onInstanceChange}>
          ...
          <SelectContent className="bg-white data-[theme=dark]:bg-gray-800 border-gray-300 data-[theme=dark]:border-gray-600">
            {instances.map((instance) => (
              <SelectItem key={instance.id} value={instance.id} className="text-gray-900 data-[theme=dark]:text-gray-100 focus:bg-gray-100 data-[theme=dark]:focus:bg-gray-700">
      ...
      <Button 
        ...
        className="bg-white data-[theme=dark]:bg-gray-800 border-gray-300 data-[theme=dark]:border-gray-600 text-gray-900 data-[theme=dark]:text-gray-100 hover:bg-gray-50 data-[theme=dark]:hover:bg-gray-700 mt-6"
      >
